...
const tests = [
  ...
  { name: '2. Database Proof Tests (Write + Read-Back)', file: 'db-proof-complete.cjs', critical: true },
  { name: '3. Concurrency Tests', file: 'concurrency-tests.cjs', critical: false },
  { name: '4. RLS & Multi-Tenant Tests', file: 'rls-multitenant-tests.cjs', critical: true },
];
