...
-- ⚠️  job_offer_messages.message_text: esiste 'body' nel DB, ma il codice usa 'message_text'
...
-- ⚠️  order_messages.message_text: esiste 'body' nel DB, ma il codice usa 'message_text'
