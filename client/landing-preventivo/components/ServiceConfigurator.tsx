...
export function ServiceConfigurator({
  ...
  const availableTreatments =
    serviceConfig.category && Array.isArray(allTreatments)
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Scegli coltura, trattamento e condizioni del campo
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            {categoriesLoading ? (
              ...
              <div className="text-center py-8 text-red-500">
                ...
                {categoriesError?.message || "Dati non validi"}
              </div>
            ) : (
                  ...
                  {availableDrones.map((drone) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-slate-500 mt-1">
                          Carico max: {drone.maxPayload}kg • Autonomia:{" "}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-slate-800">
                        Terreno collinare / pendente
                      </p>
                      <p className="text-xs text-slate-500">
                        Aumenta la complessità dell'intervento
                      </p>
                    </div>
                  </div>
                  <button
