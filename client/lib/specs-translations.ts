...
export const specsTranslations: { [key: string]: string } = {
  ...
  aircraft_weight_lifting_dual_battery_kg:
    "Peso con sistema sollevamento doppia batteria",
  aircraft_weight_spraying_2_nozzles_kg:
    "Peso con sistema irrorazione (2 ugelli)",
  aircraft_weight_spraying_4_nozzles_kg:
    "Peso con sistema irrorazione (4 ugelli)",
  ...
  multispectral_camera_max_image_size_pixels:
    "Dimensione massima immagine multispettrale",
  ...
  lifting_system_capacity_dual_battery_kg:
    "Capacità sistema sollevamento doppia batteria",
  ...
  lifting_system_dimensions_dual_battery_mm:
    "Dimensioni sistema doppia batteria",
  ...
  mtow_lifting_dual_battery:
    "Peso massimo al decollo per sollevamento (doppia batteria)",
  mtow_spraying_kg: "Peso massimo al decollo per irrorazione",
  mtow_spraying_2_nozzles_kg:
    "Peso massimo al decollo per irrorazione (2 ugelli)",
  mtow_spraying_2_nozzles_db1580_kg:
    "Peso massimo al decollo per irrorazione (2 ugelli, DB1580)",
  mtow_spraying_2_nozzles_db2160_kg:
    "Peso massimo al decollo per irrorazione (2 ugelli, DB2160)",
  mtow_spraying_4_nozzles_kg:
    "Peso massimo al decollo per irrorazione (4 ugelli)",
  mtow_spraying_4_nozzles_db1580_kg:
    "Peso massimo al decollo per irrorazione (4 ugelli, DB1580)",
  mtow_spraying_4_nozzles_db2160_kg:
    "Peso massimo al decollo per irrorazione (4 ugelli, DB2160)",
