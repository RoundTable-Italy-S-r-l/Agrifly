...
export default function Checkout() {
  ...
  const shippingCost = cartTotal > 500 ? 0 : 2.50;
      ...
      <Layout>
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold text-slate-900 mb-2">Accesso richiesto</h2>
            <p className="text-slate-600 mb-6">Devi essere loggato per procedere al checkout</p>
            <Link to="/login">
    ...
    return (
      <Layout>
        <div className="max-w-4xl mx-auto py-12">
          <div className="text-center">
            <AlertCircle className="w-12 h-12 text-slate-400 mx-auto mb-4" />
            <h2 className="text-xl font-semibold text-slate-900 mb-2">Carrello vuoto</h2>
  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto py-8">
        <Link to="/buyer/carrello" className="inline-flex items-center gap-2 text-slate-600 hover:text-slate-900 mb-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-slate-900">Indirizzo di spedizione</h2>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-semibold text-slate-900">Indirizzo di fatturazione</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setBillingAddress({ ...billingAddress, vat_number: e.target.value })}
                    />
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-slate-900">Dati di pagamento</h2>
                <span className="text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded">Stripe Mock</span>
              </div>

              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Nome sul carta *</label>
                  <Input
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Numero carta *</label>
                  <Input
                    ...
                    required
                  />
                  <p className="text-xs text-slate-500 mt-1">Usa 4242 4242 4242 4242 per test</p>
                </div>
            ...
            {/* Note */}
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <label className="block text-sm font-medium text-slate-700 mb-2">Note per l'ordine</label>
              <textarea
                value={customerNotes}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sticky top-4">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{shippingCost === 0 ? 'Gratuita' : `€${shippingCost.toFixed(2)}`}</span>
                </div>
