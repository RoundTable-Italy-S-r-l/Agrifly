    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">
          Servizi GIS Agricoli
        </h1>
        <p className="text-slate-600">
          Seleziona il tuo campo e richiedi un preventivo per i nostri servizi
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
        <div className="text-center">
          ...
          <p className="text-slate-600 text-sm mb-4">
            Usa gli strumenti della mappa per selezionare il tuo campo. Quando
            hai finito, clicca "Procedi al Configuratore" per continuare con la
            richiesta di preventivo.
          </p>
          <p className="text-xs text-slate-500">
            Verrai reindirizzato alla pagina di registrazione/login dove potrai
            completare la tua richiesta.
          </p>
        </div>
      </div>
    </div>
