...
export const RegisterOrganizationSchema = z.object({
  ...
  accountType: z
    .enum(["buyer", "provider", "vendor", "operator"])
    .transform((val) => {
...
export const CreateOfferSchema = z.object({
  offer_type: z.enum(["BUNDLE", "PROMO", "SEASON_PACKAGE"], {
    errorMap: () => ({
      message: "Tipo offerta deve essere BUNDLE, PROMO o SEASON_PACKAGE",
    }),
  }),
  ...
  valid_from: z
    ...
    .refine(
      ...
      {
        message:
          "Data valid_from non valida (formato ISO richiesto: YYYY-MM-DD)",
      },
    )
  ...
  valid_to: z
    ...
    .refine(
      ...
      {
        message: "Data valid_to non valida (formato ISO richiesto: YYYY-MM-DD)",
      },
    )
...
export type CertifiedQuotesRequest = z.infer<
  typeof CertifiedQuotesRequestSchema
>;
