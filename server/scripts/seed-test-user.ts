  ...
  try {
    ...
    const operatorUser = await prisma.user.create({
      data: {
        ...
        password_hash: await hashPassword(process.env.SEED_TEST_PASSWORD || 'password123'),
        email_verified: true,
        status: 'ACTIVE'
      }
    });
    ...
    const jobs = [
      {
        ...
        service_type: 'SPRAY',
        status: 'OPEN',
        field_polygon: '{"type":"Polygon","coordinates":[[[11.2,43.1],[11.3,43.1],[11.3,43.2],[11.2,43.2],[11.2,43.1]]]}',
        location_json: '{"centroid":[11.25,43.15],"address":"Chianti, Toscana","comune":"Gaiole in Chianti"}',
        requested_window_start: new Date('2025-01-15'),
        requested_window_end: new Date('2025-01-20'),
        constraints_json: '{"crop_type":"vigneto","urgency":"normal","obstacles":"nessuno"}',
      },
      {
        ...
        service_type: 'SPRAY',
        status: 'OPEN',
        field_polygon: '{"type":"Polygon","coordinates":[[[11.5,43.3],[11.6,43.3],[11.6,43.4],[11.5,43.4],[11.5,43.3]]]}',
        location_json: '{"centroid":[11.55,43.35],"address":"Crete Senesi, Toscana","comune":"Asciano"}',
        requested_window_start: new Date('2025-01-10'),
        requested_window_end: new Date('2025-01-12'),
        constraints_json: '{"crop_type":"oliveto","urgency":"high","obstacles":"strade interne"}',
      },
      {
        ...
        status: 'OPEN',
        field_polygon: '{"type":"Polygon","coordinates":[[[11.4,43.0],[11.7,43.0],[11.7,43.3],[11.4,43.3],[11.4,43.0]]]}',
        location_json: '{"centroid":[11.55,43.15],"address":"Val d\'Orcia, Toscana","comune":"Pienza"}',
        requested_window_start: new Date('2025-01-08'),
        requested_window_end: new Date('2025-01-10'),
        constraints_json: '{"crop_type":"mais","urgency":"normal","obstacles":"fossi"}',
      }
    ];
    ...
    for (const jobData of jobs) {
      ...
      const pricingSnapshot = {
        ...
        calculation: {
          ...
          total: Math.round((job.service_type === 'SPRAY' ? 35 : 75) * job.area_ha * 100)
        }
      };
    ...
    console.log(`🔑 Password: ${testPassword} (configura SEED_TEST_PASSWORD per cambiarla)`);
