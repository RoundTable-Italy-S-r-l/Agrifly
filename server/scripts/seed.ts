...
async function main() {
  ...
  console.log(
    "ℹ️  Drones e Affiliates devono essere popolati tramite le nuove tabelle Products/OperatorProfiles",
  );
