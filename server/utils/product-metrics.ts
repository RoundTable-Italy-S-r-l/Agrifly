...
export const METRIC_CLUSTERS = {
  ...
  'Caricatore': [
    'charger_charge_time_min'
  ],
  'Generatore': [
    'generator_fuel_consumption_ml_kwh'
  ],
  'Radar': [
 ...
 */
export function normalizeProductSpecs(specs: any[]): Record<string, number | null> {
...
export function calculateMinMax(
  allProductsMetrics: Array<{ productId: string; metrics: Record<string, number | null> }>
